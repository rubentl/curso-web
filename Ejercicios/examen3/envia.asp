...
'ObjSendMail.HTMLBody = "<!DOCTYPE html><html lang='es'><head><meta charset='UTF-8'><title>Formulario</title></head><body><h1>Nuevos datos de la Página Web</h1>  <h2>"&request.Form("nombre")&"</h2><blockquote><p>E-Mail: "&request.Form("email")&"</p><p>Teléfono: "&request.Form("telefono")&"</p><p>Tipo de Información: "&request.Form("tipo")&"</p><p>Comentario: "&request.Form("comentario")&"</p></blockquote></body></html>"
